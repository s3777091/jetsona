...
lv_obj_t *CreateAirplaneIcon(lv_obj_t *parent, lv_color_t color) {
    ...
    // Nose points to the upper-right. The two bent strokes form the wings and
    // tail around a thicker fuselage, matching the familiar settings glyph.
