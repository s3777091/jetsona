...
Trong Chromium kiosk, nhấn `Ctrl+Alt+Backspace` để đóng phiên bare-X và quay
lại firmware. Bare-X cần `xserver-xorg-input-libinput` để nhận bàn phím/chuột
và `x11-xkb-utils` để bật phím thoát này; cài các gói theo
